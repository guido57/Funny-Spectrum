...
Audio::Audio(const uint8_t BCLK, const uint8_t LRC, const uint8_t DOUT) {
    ...
    m_i2s_config.use_apll             = APLL_DISABLE; //GG APLL_ENABLE;
    ...
    playSampleCallback = nullptr;

}
//---------------------------------------------------------------------------------------------------------------------
void Audio::setPlaySampleCallback(void  (* _playSampleCallback)(int16_t samples[2])){
    playSampleCallback = _playSampleCallback;
}
//-------------------------------------------------------------------------------------------
...
bool Audio::playSample(int16_t sample[2]) {
    ...
    if(playSampleCallback != nullptr) 
        playSampleCallback(sample);
